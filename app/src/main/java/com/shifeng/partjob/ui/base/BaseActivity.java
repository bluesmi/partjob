...
import com.shifeng.partjob.R;
import com.shifeng.partjob.ui.AppManager;
import com.shifeng.partjob.util.LogUtils;
import com.shifeng.partjob.util.StatusBar;

import java.util.ArrayList;
import java.util.List;

/**
 *  * 作者：朋来-GZQ on 2017/1/6 13:54
...
public abstract class BaseActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (isTranslucentStatusBar()) {
            StatusBar.translucent(activity, getResources().getColor(R.color.white));
        }
