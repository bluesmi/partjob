package com.shifeng.partjob.util;
...
public class LogUtils {
    ...
    private static boolean isDebug = LogConfig.DEBUG_ENABLE;// 是否调试模式
    private static String debugTag = LogConfig.DEBUG_TAG;// LogCat的标记
